<?php
$paypalConfig = json_decode(file_get_contents('../../config/paypal.json'));
// Include the composer Autoloader
// The location of your project's vendor autoloader.
$composerAutoload = '/Applications/MAMP/htdocs/php-pp-spb-example/PayPal-PHP-SDK/autoload.php';
...
$apiContext = getApiContext($paypalConfig->client_id, $paypalConfig->client_secret);
return $apiContext;
/**
