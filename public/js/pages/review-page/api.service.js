...
angular.module('phpApp').service('reviewPageModel', function ($http, $cookies, $location) {
	...
	function getPaymentDetails() {
		...
		const reqUrl = $location.protocol() + '://' + $location.host() + ':' + $location.port() + '/php-pp-spb-example/api/paypal/index.php/query/' + model.action.onAuthorize.paymentID
	...
	function executePayment() {
		...
		const reqUrl = $location.protocol() + '://' + $location.host() + ':' + $location.port() + '/php-pp-spb-example/api/paypal/index.php/execute/' + model.action.onAuthorize.paymentID
		const config = {
